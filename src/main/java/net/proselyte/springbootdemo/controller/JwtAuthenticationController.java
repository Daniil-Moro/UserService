...
import net.proselyte.springbootdemo.model.requests.AuthenticateRequest;
...
import net.proselyte.springbootdemo.service.JwtUserDetailsService;


import net.proselyte.springbootdemo.config.JwtTokenUtil;
import net.proselyte.springbootdemo.model.JwtResponse;
